<template>
  <div class="container">
    <div class="left-side">
        ...
        <v-card>
          ...
          <v-card-text>
            ...
            >
              ...
              />
              <v-text-field
                v-model="userToUpdate.passwordUser"
                label="Password"
                type="password"
          ...
          <v-card-actions>
            <v-row>
              ...
              <v-col cols="6">
                <v-btn color="green darken-1" elevation="0" block @click="ActualizarContacto(item)">
                  <span style="text-transform: none; color: white">
                    Actualizar
                  </span>
                </v-btn>
      ...
      <v-btn color="#E0E0E0" elevation="0" block @click="VelaStaryPayment">
        <span style="text-transform: none; color: green">
          Go to Payment
        </span>
      </v-btn>
...
export default {
  ...
  methods: {
    VelaStaryPayment () {
      this.$router.push('/velasCinco/velasCincoCar/velasCincoDetails/velasCincoShipping/velasCincoPayment')
    },
    Actualizar (user) {
    ...
    backDetails () {
      this.$router.push('/velasCinco/velasCincoCar/velasCincoDetails')
    }
  }
}
</script>
